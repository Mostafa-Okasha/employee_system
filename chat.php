...
<div class = "container">		
	<div class = "col-md-6 col-md-offset-3 chat_box" id="chatbox">
		...
		<br />
        <?php
        $stmt1=$con->prepare("SELECT * FROM employees where id=?");
        $stmt1->execute(array($emp_id));
        $rows1=$stmt1->fetch();
        ?>
		<div class = "form-group">
            <input type = "text" value = "<?php echo $rows1['name']; ?>" class = "input_name form-control" placeholder = "Enter Name" />
		</div>
		<div class = "form-group">
...
var pusher = new Pusher('0236851609a3ec023318', {
    cluster: 'mt1',
    encrypted: true
});
